        ...
        <section className='w-full pb-[140px]'>
            <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row gap-[30px]">
                    <Link to='/signup' className="w-full lg:w-1/2 h-[400px] md:h-[600px] rounded-[4px] overflow-hidden cursor-pointer relative">
                    ...
                    <Link to='/signup' className="w-full lg:w-1/2 h-auto flex flex-col gap-[30px]">
                        ...
                        <div className="w-full h-auto md:h-1/2 flex flex-col sm:flex-row gap-[30px]">
                            <Link to='/signup' className="w-full sm:w-1/2 h-[200px] md:h-full rounded-[4px] overflow-hidden cursor-pointer relative">
